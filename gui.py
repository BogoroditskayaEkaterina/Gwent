...
Btn6 = Button(content, text="Очистить все", width=15, height=3, background="#370008", foreground="#ccc",
...
Btn11 = Button(content, text="Тригг. инд. функ.", width=15, height=3, background="#370008", foreground="#ccc",
